...
license: MIT
compatibility: Requires AGENTS.md and the configuration generated by lodestar-setup. Works in any repository whose packages and dependency direction are documented there.
metadata:
  author: Ilan Cohen
  version: "0.1.0"
---
...
To act:
  ...
  - If you change the layout, refactor (one PR per move, ideally), then
    re-run `lodestar-setup` so AGENTS.md reflects the new
    structure.
```
