...
| Path                            | Responsibility                                                            |
| ------------------------------- | ------------------------------------------------------------------------- |
| `skills/lodestar-setup/`        | Base skill: context, principles, shared `scripts/` modules                |
...
- Partial installs are supported when they include `lodestar-setup` as
  ...
  `architecture` and `docs` may stand alone with setup.   Shared modules live only in `skills/lodestar-setup/scripts/` (including
  `pkg-manager.mjs` and `workspace-layout.mjs`), and other skills reach
