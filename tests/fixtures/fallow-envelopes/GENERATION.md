...
./node_modules/.bin/fallow list --entry-points --format json --quiet > "$OLDPWD/$OUT/v3.15.0/list-entry-points.json"
...
./node_modules/.bin/fallow list --entry-points --format json --quiet > "$OLDPWD/$OUT/v3.17.0/list-entry-points.json"
